            ...
            <div class="col-sm-8">
                ...
                <form v-on:submit.prevent="submit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="address" v-model="user.address" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" placeholder="自己紹介を入力" id="self_introduction" v-model="user.self_introduction" required></textarea>
                        </div>
                    </div>                    
                    <div class="form-group row">
                        <label for="email" class="col-sm-3 col-form-label">メールアドレス</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="●●●@nhoの形式で入力してください" id="email" v-model="user.email" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="password" class="col-sm-3 col-form-label">パスワード</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="8文字以上の英数字" id="password" v-model="user.password" required>
                        </div>
                    </div>
