...
<nav class="navbar navbar-light bg-theme p-3 px-md-4 mb-3 bg-theme border-bottom shadow-sm" id="pc-header">
    ...
    <nav class="navbar navbar-light bg-theme p-3 px-md-4 mb-3 bg-theme border-bottom shadow-sm" id ="sp-header">
